...
In order to isolate the information from other applications which could be 
using the Context Broker, the `fiware-service: tourguide` header should be used in every request.
